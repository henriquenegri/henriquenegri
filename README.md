...
👾 Seja bem-vindo ao meu perfil! Aqui você encontrará minha jornada como dev, conquistas desbloqueadas e missões em andamento.  
...
- **Level:** 🚀 em constante evolução  
- **Guilda:** Comunidade Tech  
- **Inventário:**  
  ☕ Café + 🎧 Música + 💻 Código = 💡 Ideias  
  🎮 Jogos para inspiração e diversão  

---

## 🏆 Conquistas

- 🟢 `Hello World` — Primeiro código rodando  
- 🔵 `Full-Stack Explorer` — Frontend + Backend  
- 🟣 `Code Summoner` — Deploys mágicos com Docker & Cloud  
- 🟡 `Boss Slayer` — Resolver bugs às 3 da manhã  
- 🔴 `Team Player` — Projetos em colaboração  
...
<details open>
  <summary>Inventário de Habilidades</summary>
  <br/>
  ...
  <table width="100%">
    ...
    <tr>
      ...
      <td>
        ...
        <img alt=".NET Core" height="30" width="40" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/dotnetcore/dotnetcore-original.svg" />
...
- 🌟 Criar projetos open-source para a comunidade  
- ⚡ Aprimorar minhas skills em DevOps & Cloud  
- 🧩 Desenvolver jogos indie como hobby  

---

## 💬 Multiplayer (Conecte-se comigo)

<div align="center">
  <a href="https://instagram.com/henrique_negri1" target="_blank"><img src="https://img.shields.io/badge/-Instagram-%23E4405F?style=for-the-badge&logo=instagram&logoColor=white"></a>
